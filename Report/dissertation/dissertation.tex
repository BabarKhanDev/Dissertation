...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|lll|}
        ...
        Kitchen                & \multicolumn{1}{c|}{0.12}        & \multicolumn{1}{c|}{0.072}& \multicolumn{1}{c|}{0.35}            \\ \hline
        Living Room            & \multicolumn{1}{c|}{0.13}        & \multicolumn{1}{c|}{0.047}& \multicolumn{1}{c|}{0.28}            \\ \hline
        Conf. Room             & \multicolumn{1}{c|}{0.17}        & \multicolumn{1}{c|}{0.091}& \multicolumn{1}{c|}{0.34}            \\ \hline
        House                  & \multicolumn{1}{c|}{0.13}        & \multicolumn{1}{c|}{0.075}& \multicolumn{1}{c|}{0.25}            \\ \hline
        Airport Ter.           & \multicolumn{1}{c|}{0.15}        & \multicolumn{1}{c|}{0.085}& \multicolumn{1}{c|}{0.29}            \\ \hline
        Skyscraper             & \multicolumn{1}{c|}{0.31}        & \multicolumn{1}{c|}{0.14 }& \multicolumn{1}{c|}{0.31}            \\ \hline
        Amus. Park             & \multicolumn{1}{c|}{0.14}        & \multicolumn{1}{c|}{0.086}& \multicolumn{1}{c|}{0.44}            \\ \hline
        Playground             & \multicolumn{1}{c|}{0.14}        & \multicolumn{1}{c|}{0.079}& \multicolumn{1}{c|}{0.34}            \\ \hline
        Pasture                & \multicolumn{1}{c|}{0.11}        & \multicolumn{1}{c|}{0.056}& \multicolumn{1}{c|}{0.37}            \\ \hline
        Golf Course            & \multicolumn{1}{c|}{0.13}        & \multicolumn{1}{c|}{0.076}& \multicolumn{1}{c|}{0.34}            \\ \hline
        Mountain               & \multicolumn{1}{c|}{0.19}        & \multicolumn{1}{c|}{0.094}& \multicolumn{1}{c|}{0.32}            \\ \hline
        Badland                & \multicolumn{1}{c|}{0.20}        & \multicolumn{1}{c|}{0.096}& \multicolumn{1}{c|}{0.23}            \\ \hline
        
        Populated              & \multicolumn{1}{c|}{0.20}       & \multicolumn{1}{c|}{0.0077}& \multicolumn{1}{c|}{0.34}            \\ \hline
        Big                    & \multicolumn{1}{c|}{0.20}        & \multicolumn{1}{c|}{0.014}& \multicolumn{1}{c|}{0.29}            \\ \hline
        Public Ent.            & \multicolumn{1}{c|}{0.20}        & \multicolumn{1}{c|}{0.018}& \multicolumn{1}{c|}{0.31}            \\ \hline
        Isolated               & \multicolumn{1}{c|}{0.20}        & \multicolumn{1}{c|}{0.029}& \multicolumn{1}{c|}{0.28}            \\ \hline
        Small                  & \multicolumn{1}{c|}{0.20}        & \multicolumn{1}{c|}{0.016}& \multicolumn{1}{c|}{0.34}            \\ \hline
        Work-Home              & \multicolumn{1}{c|}{0.20}        & \multicolumn{1}{c|}{0.027}& \multicolumn{1}{c|}{0.24}            \\ \hline
        \hline
        Mean                   & \multicolumn{1}{c|}{0.14}        & \multicolumn{1}{c|}{0.077}& \multicolumn{1}{c|}{0.31}            \\ \hline
        Median                 & \multicolumn{1}{c|}{0.13}        & \multicolumn{1}{c|}{0.075}& \multicolumn{1}{c|}{0.31}            \\ \hline
        Std                    & \multicolumn{1}{c|}{0.052}       & \multicolumn{1}{c|}{0.022}& \multicolumn{1}{c|}{0.047}           \\ \hline
    \end{tabular}
