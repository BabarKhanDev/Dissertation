...
In this experiment I trained a modified conditional diffusion model as described in section \ref{DIFFUSION_METHODS}. I found that the best parameters for this network were: Group Normalisation, Encoder channel layout = (64, 128, 256, 512), Decoder channel layout = (512, 256, 128, 64), and a cosine beta scheduler with a start of 1e-6 and an end of 0.02.
