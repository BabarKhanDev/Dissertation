...
% TALK ABOUT THE BEST IMAGES
A sample of the lowest accuracy output images can be seen in figure \ref{fig:autoencoderWorstOutput}.
% TALK ABOUT THE WORST IMAGES
As you can see the autoencoder tends to turn the blocky VMS shape into a rounded circle. It is less accurately able predict the red regions, this is likely due to there being far more green data than red data.
...
%talk about specific boring images
...
You can also see a selection of the worst model predictions in figure \ref{fig:DiffusionWorstOutput}
% talk about specific images
