...
This report is organised as follows: Chapter 3 discusses existing literature in image memorability, Chapter 4 discusses the project methodology, I describe available deep learning datasets and existing image to image models, Chapter 5 details my experiments and results, and Chapter 6 my conclusion, where I discuss the implications of my findings.    
...
% Lets talk a bit about video memorability

In \cite{HASSON2004,HASSONNeurocinematics,HASSON2008} it is shown by Hasson et al. that using fMRI scans we can accurately measure video memorability, 
% 22 in the computational paper talks about showing correlations between signals and semantic content in the movie. I should talk about all 3 of these and what they do
This is then built on by Junwei et al. in \cite{fMRIPredictions} where they create a memorability experiment composed of videos rather than images, they then train a prediction model across the fMRI data to predict the memorability of unseen videos.  
