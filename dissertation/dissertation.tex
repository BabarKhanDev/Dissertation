...
The UNet is an autoencoder model presented in \cite{ronneberger2015unet}. While its original creation was for the purpose of image classification, I think it should perform well in the task of generating VMS maps, in fact I would even consider generating VMS maps a continuous version of image segmentation.

\textbf{Model}: I will use a UNet autoencoder that takes as input a 64x64x3 tensor of floating point values in the range [-1,1], these are the images in our dataset.
