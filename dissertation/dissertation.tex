...
The VISCHEMA dataset is split into 12 different categories, below we can see the accuracy that each model achieves within a category.

\begin{table}[]
    \begin{tabular}{|l|lll}
    \hline
                 & \multicolumn{3}{c|}{Model}                                                                         \\ \hline
    Category     & \multicolumn{1}{l|}{AutoEncoder} & \multicolumn{1}{l|}{GAN} & \multicolumn{1}{l|}{Diffusion Model} \\ \hline
    Kitchen      &                                  &                          &                                      \\ \cline{1-1}
    Living Room  &                                  &                          &                                      \\ \cline{1-1}
    Conf. Room   &                                  &                          &                                      \\ \cline{1-1}
    Airport Ter. &                                  &                          &                                      \\ \cline{1-1}
    House        &                                  &                          &                                      \\ \cline{1-1}
    Skyscraper   &                                  &                          &                                      \\ \cline{1-1}
    Amus. park   &                                  &                          &                                      \\ \cline{1-1}
    Playground   &                                  &                          &                                      \\ \cline{1-1}
    Pasture      &                                  &                          &                                      \\ \cline{1-1}
    Golf Course  &                                  &                          &                                      \\ \cline{1-1}
    Mountain     &                                  &                          &                                      \\ \cline{1-1}
    Badland      &                                  &                          &                                      \\ \cline{1-1}
    \end{tabular}
    \end{table}
