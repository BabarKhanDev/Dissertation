...
R. Nickerson worked on [Short-term memory for complex meaningful visual configurations] where he found that subjects shown a series of images are, with great accuracy, able to recall if the photo is one they have seen before or not. If we consider an old image one that subjects have seen before and a new image one they have not, then it was found that subjects shown one image at a time with a 50\% chance of that image being old or new are able to correctly distinguish them with 95\% of the time.

L.Standing built on the work of Nickerson in [Learning 10,000 pictures]. Four experiments were ran which tested memory capacity and retreival speed for pictures and words, I am interested in the performance related to pictures specifically. He found that the capacity for image recognition from memory is almost limitless, when measured under testing conditions. 

In Standing's first experiment he tested 'normal' and 'vivid' images. He describes 'normal' images as being "characterized as resembling a highly variegated collection of competent snapshots"[Learning 10,000 pictures, p.208], and 'vivid' images are described as "striking pictures ... with definitely interesting subject matter"[Learning 10,000 pictures, p.208]. This work is important because it directly builds on the work of Nickerson and adds classification to images.
